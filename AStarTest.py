...
class MyTestCase(unittest.TestCase):
    ...
    def testUnsolvableManhattan(self):
        ...
        astar = AStar(initialState, goalState, "manhattan")
        report = astar.getReport()
        self.assertEqual(report[0], ['right', 'up', 'up', 'left', 'left', 'down', 'down', 'right', 'right', 'up', 'left', 'left', 'down', 'right', 'right', 'up', 'left', 'up', 'right', 'down', 'left', 'up', 'left', 'down', 'down', 'right', 'right', 'up', 'left', 'down', 'right'])
